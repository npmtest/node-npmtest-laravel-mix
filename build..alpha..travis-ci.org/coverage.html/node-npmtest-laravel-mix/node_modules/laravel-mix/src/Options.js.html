...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-laravel-mix/node_modules/laravel-mix/src/Options.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-laravel-mix/node_modules/laravel-mix/src/Options.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-laravel-mix/node_modules/laravel-mix/src/</a> &#187; Options.js</div>
</div>
<div class="body">
...
&nbsp;
     ...
     */
    merge<span class="fstat-no" title="function not covered" >(options) {</span>
<span class="cstat-no" title="statement not covered" >        let mergeWith = require('lodash').mergeWith;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        mergeWith(this, options, (objValue, srcValue) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            if (Array.isArray(objValue)) {</span>
<span class="cstat-no" title="statement not covered" >                return objValue.concat(srcValue);</span>
            }
        });
    }
};
